const DefaultPalette = (mode, skin) => {
  ...
  return {
    customColors: {
      ...
      borderColor: mode === 'light' ? '#4c4e641f' : '#eaeaff1f',
      calendarSelect: mode === 'light' ? '#e6e6e6' : '#eaeaff1f',
      calendarWeekend: mode === 'light' ? '#ff4f4f' : '#ff4f4f',
      calendarHoverColor: mode === 'light' ? '#' : '#ff4f4f',
      navArCalendar: mode === 'light' ? '#fff' : '#eaeaff1f'
    },
    common: {
      black: '#000',
      white: '#FFF'
