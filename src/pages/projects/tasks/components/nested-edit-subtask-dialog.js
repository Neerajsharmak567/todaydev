      ...
      >
        <DialogContent sx={{ pb: 6, px: { xs: 8, sm: 12 }, pt: { xs: 8, sm: 12.5 }, position: 'relative' }}>
          ...
          <Box sx={{ mb: 8 }}>
            ...
            <Typography variant='body2'>Edit nested subtask by modifying the given form.</Typography>
          </Box>
            ...
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Autocomplete
                  ...
                  getOptionLabel={option => option.taskName}
                  readOnly
                  renderInput={params => <TextField {...params} label='Sub task' />}
                />
              </Grid>
              <Grid item xs={12} sm={12}>
                <TextField fullWidth label='Task Name' placeholder='Task name' defaultValue='Prototype' />
              </Grid>
              ...
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  style={{ width: '100%' }}
                  defaultValue='This the description of the nested subtask.'
                />
              </Grid>
              <Grid item xs={12} sm={12}>
                <Autocomplete
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField fullWidth label='Estimation (Hours)' placeholder='Estimation (Hours)' defaultValue='8' />
              </Grid>
              <Grid item xs={12} sm={12}>
                <DropzoneWrapper>
