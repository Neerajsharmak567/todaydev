...
const SubTaskDialogue = () => {
  ...
  return (
    <>
      <Tooltip title='Add nested subtask' arrow>
      ...
      >
        <DialogContent sx={{ pb: 6, px: { xs: 8, sm: 12 }, pt: { xs: 8, sm: 12.5 }, position: 'relative' }}>
          ...
          <Box sx={{ mb: 8 }}>
            ...
            <Typography variant='body2'>You can add nested subtask by filling the given form.</Typography>
          </Box>
          <form onSubmit={e => e.preventDefault()}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <TextField fullWidth label='Task Name' placeholder='Task name' />
              </Grid>
