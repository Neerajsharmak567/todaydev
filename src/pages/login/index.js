...
const LoginPage = () => {
  ...
  const { axiosReq, error, response: userData } = useAxios()
  // ** Hooks
      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            >
              <img src='/images/logo/dark-logo.png' alt='logo' className='logo' />
            </Box>
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>{`Welcome back! 👋🏻`}</TypographyStyled>
              <Typography variant='body2'>Please sign-in to project management portal.</Typography>
            </Box>
